...
import com.src.kanchanaratplace.api_util.getApprovedRepairUtility
...
@Composable
fun RepairPendingScaffold(navController: NavHostController){
    SampleScaffold(navController,"กำลังดำเนินการ"){
        RepairPendingScreen(navController)
    }
}

@Composable
fun RepairPendingScreen(navController : NavHostController){
