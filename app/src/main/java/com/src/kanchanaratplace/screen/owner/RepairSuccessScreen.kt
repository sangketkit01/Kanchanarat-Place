...
import com.src.kanchanaratplace.api_util.getSuccessRepairUtility
...
@Composable
fun RepairSuccessScaffold(navController: NavHostController){
    SampleScaffold(navController,"ซ่อมแล้ว"){
        RepairSuccessScreen(navController)
    }
}

@Composable
fun RepairSuccessScreen(navController : NavHostController){
